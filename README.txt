...
make a symlink to eschalon_b1_char.py, eschalon_b1_map.py, and
eschalon_b2_char.py into somewhere in your $PATH (~/bin is probably the best
...
cd /path/to/folder/containing/eschalon_utils
./Eschalon\ Utils.app/Contents/MacOS/eschalon_utils
